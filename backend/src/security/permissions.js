...
const PERMISSIONS = Object.freeze({
  ...
  SERVICE_COMPLETION_CREATE: "service_completion.create",
  SERVICE_COMPLETION_VERIFY: "service_completion.verify",
  SERVICE_COMPLETION_REVERSE: "service_completion.reverse",
  REVENUE_RECOGNITION_VIEW: "revenue_recognition.view",
  REVENUE_RECOGNITION_PREVIEW: "revenue_recognition.preview",
  REVENUE_RECOGNITION_POST: "revenue_recognition.post",
  REVENUE_RECOGNITION_REVERSE: "revenue_recognition.reverse",
  ...
  APPROVE_EXPENSE: "business_expense.approve",
  POST_EXPENSE: "business_expense.post",
  REVERSE_EXPENSE: "business_expense.reverse",
...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  [ROLES.STAFF]: [
    ...
    PERMISSIONS.SETTLEMENT_ALLOCATE,
    PERMISSIONS.SETTLEMENT_RECONCILE,
    PERMISSIONS.SETTLEMENT_IMPORT,
    PERMISSIONS.SERVICE_COMPLETION_VIEW,
    PERMISSIONS.SERVICE_COMPLETION_CREATE,
    PERMISSIONS.SERVICE_COMPLETION_VERIFY,
    PERMISSIONS.SERVICE_COMPLETION_REVERSE,
    PERMISSIONS.REVENUE_RECOGNITION_VIEW,
    PERMISSIONS.REVENUE_RECOGNITION_PREVIEW,
    PERMISSIONS.GL_PREVIEW_POSTING,
