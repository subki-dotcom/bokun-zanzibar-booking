...
const env = cleanEnv(process.env, {
  ...
  BOKUN_TIMEOUT_MS: num({ default: 20000 }),
  ...
  PESAPAL_SUCCESS_URL: str({ default: "http://127.0.0.1:5173/payment-success" }),
  PESAPAL_CANCEL_URL: str({ default: "http://127.0.0.1:5173/payment-failure" }),
  ...
  DPO_SUCCESS_URL: str({ default: "http://127.0.0.1:5173/payment-success" }),
  DPO_CANCEL_URL: str({ default: "http://127.0.0.1:5173/payment-failure" }),
